...
class Config:
    def __init__(self):
        ...
        # Adding virtual camera and IoU threshold parameters
        parser.add_argument('-cam1_size', '--camera1_size', type=int, default=224, help='Size of Camera 1 frame (n x n)')
        parser.add_argument('-iou_thresh', '--iou_threshold', type=float, default=0.5, help='IoU threshold for evaluation')
        parser.add_argument('-vis_cam', '--visualize_cameras', action='store_true', default=False, help='Visualize both cameras')
...
# Update model configuration for virtual cameras
        self.model_cfg.update({
            'cam1_feature_num': self.model_cfg['BBX5_feature_num'],  # Features for Camera 1
            'cam2_feature_num': self.model_cfg['BBX5_feature_num'],  # Features for Camera 2
            'cam1_size': self.camera1_size,
